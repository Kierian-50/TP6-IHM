...
public class DisplayWelcomePage {
    ...
    private JPanel createImageForegroundWelcomePage(){
        ...
        try {
            ...
            JLabel label = new JLabel(new ImageIcon(ImageIO.read(new File("data/imageBateauAVoile.JPG"))));
            ret.add(label);
    ...
    private JPanel namePageSwitchEntrainemet(){
        ...
        try {
            ...
            JLabel label = new JLabel(new ImageIcon(ImageIO.read(new File("data/switchPageEntrainement.JPG"))));
            ret.add(label);
    ...
    private JPanel switchButtonRight(){
        ...
        try {
            Image img = ImageIO.read(new File("data/flecheDroiteTom.PNG"));
    ...
    private JPanel switchButtonLeft(){
        ...
        try {
            Image img = ImageIO.read(new File("data/flecheGaucheTom.PNG"));
    ...
    private JPanel namePageSwitchMeteo(){
        ...
        try {
            ...
            JLabel label = new JLabel(new ImageIcon(ImageIO.read(new File("data/switchPageMeteo.JPG"))));
            ret.add(label);
    ...
    private JPanel imageMeteo(){
        ...
        try {
            ...
            JLabel label = new JLabel(new ImageIcon(ImageIO.read(new File("data/meteoPage.JPG"))));
            ret.add(label);
    ...
    private JPanel namePageSwitchHistorique(){
        ...
        try {
            ...
            JLabel label = new JLabel(new ImageIcon(ImageIO.read(new File("data/switchPageHistorique.JPG"))));
            ret.add(label);
